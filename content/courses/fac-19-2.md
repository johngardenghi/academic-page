...
* **Inscreva-se** [aqui](https://forms.gle/76ZMWQuzdfFswcZJ6) para a _**prova substitutiva**_.
...
* **Aula 16** - 18/out
  * Aritmética computacional
     * Ponto flutuante (padrão de representação, adição e multiplicação)

\

* **Aula 17** - 21/out
  * Aritmética computacional
     * Ponto flutuante (instruções do assembly MIPS)
  * [Trabalho 2](/courses/2019_2/fac/trabalho2.pdf)
  * _Sugestão de leitura_
     * *Seção 3.6* (*3<sup>a</sup> edição*)
     * *Seção 3.5* (*4<sup>a</sup> e 5<sup>a</sup> edições*)

\

* **Aula 18** - 25/out
  * Arquitetura interna de um processador
     * Elementos de um caminho de dados (etapa comum, instruções lógicas e aritméticas)

\

* **Aula 19** - 28/out
  * Arquitetura interna de um processador (ver [slides](/courses/2019_2/fac/4_arquitetura_processador_slides.pdf))
     * Elementos de um caminho de dados (instruções de acesso à memória e de desvio condicional)
     * Um caminho de dados completo
  * _Sugestão de leitura_
     * *Seções 5.1 e 5.3* (*3<sup>a</sup> edição*)
     * *Seções 4.1 e 4.3* (*4<sup>a</sup> e 5<sup>a</sup> edições*)
...
* **Aula 20** - 01/nov
  ...
  * _Sugestão de leitura_
     * *Seção 5.4* (*3<sup>a</sup> edição*)
     * *Seção 4.4* (*4<sup>a</sup> e 5<sup>a</sup> edições*)
...
* **Aula 21** - 04/nov
  * Arquitetura interna de um processador (ver [slides](/courses/2019_2/fac/4_arquitetura_processador_slides.pdf))
     * Pipeline
     * Hazards de pipeline (estruturais e de dados)
   * _Sugestão de leitura_
     * *Seção 6.1* (*3<sup>a</sup> edição*)
     * *Seção 4.5* (*4<sup>a</sup> e 5<sup>a</sup> edições*)

\

* **Aula 22** - 08/nov
  * Professor em viagem (Final Brasileira da Maratona Programação)
  * [Exercícios](https://moj.naquadah.com.br/cgi-bin/contest.sh/jl_facb20192_l2) no CD-MOJ

\

* **Aula 23** - 11/nov
  * Arquitetura interna de um processador (ver [slides](/courses/2019_2/fac/4_arquitetura_processador_slides.pdf))
     * Hazards de pipeline (controle)
     * Caminho de dados e controle no pipeline
  * Hierarquia de memória
     * Introdução
  * _Sugestão de leitura_
     * *Seções 6.2 e 6.3* (*3<sup>a</sup> edição*)
     * *Seção 4.6* (*4<sup>a</sup> e 5<sup>a</sup> edições*)
...
* **Aula 24** - 18/nov
  ...
  * _Sugestão de leitura_
     * *Seção 7.1* (*3<sup>a</sup> edição*)
     * *Seção 5.1* (*4<sup>a</sup> edição*)
     * *Seções 5.1 e 5.2* (*5<sup>a</sup> edição*)
...
* **Aula 27** - 29/nov
  * Hierarquia de memória - Memória cache
     ...
     * Cache multinível
  * _Sugestão de leitura_
     * *Seções 7.2 e 7.3* (*4<sup>a</sup> edição*)
     * *Seções 5.2 e 5.3* (*4<sup>a</sup> edição*)
     * *Seções 5.3 e 5.4* (*5<sup>a</sup> edição*)
